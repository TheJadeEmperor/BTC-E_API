...
function showPoloBalanceTable($polo, $tableTitle) {
	...
	<table class="table">
		<thead class="thead-default">
			<tr>
				<th colspan="8"><?=$tableTitle?> <img src="include/refresh.png" class="clickable" onclick="javascript:reloadTable('#balanceTable')" width="25px" /> </th>
			</tr>
		</thead>
		<tbody>
			<tr>
...
/*
	...
	*/
	...
	<table class="table">
		<thead class="thead-default">
			<tr>
				<th colspan="8">Bitmex-2 Positions <img src="include/refresh.png" class="clickable" onclick="javascript:reloadTable('#bitmexPositions2')" width="25px" /> </th>
			</tr>
			<tr>
				<th>Symbol</th><th>openingQty</th><th>markPrice</th><th>avgEntryPrice</th><th>breakEvenPrice</th><th>unrealisedGrossPnl</th><th>liquidationPrice</th>
			</tr>
